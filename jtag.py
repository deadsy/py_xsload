...
IDCODE_XC2C32A = 0x06e18093

device_table = (
    (IDCODE_XC9572XL, 'Xilinx XC9572XL CPLD', 8, 0x0fffffff),
    (IDCODE_XC3S1000, 'Xilinx XC3S1000 FPGA', 6, 0xffffffff),
    (IDCODE_XC3S200A, 'Xilinx XC3S200A FPGA', 6, 0x0fffffff),
    (IDCODE_XC2C32A, 'Xilinx XC2C32A CPLD',   8, 0x0fff8fff),
)
